...
const DoctorProfileView = () => {
    ...
    const { _id, name, image, specialist, email, phone, visitFee, rating, chamberLocation, experience, category, about, education, overview } = doctor;
                            ...
                            <div className='w-1/2 md:ml-10'>
                                <div className="card-body text-left">
                                    ...
                                    <div className="card-actions mt-2">
                                        <button onClick={handleDoctorAppointment} className="btn btn-outline border-0 border-b-4 border-t-4 font-bold text-green-400 border-green-600 hover:bg-green-600 hover:border-none">Appointment</button>
                                    </div>
                                </div>
                            </div>
                        </div>
