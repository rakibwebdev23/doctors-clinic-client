...
const Footer = () => {
    return (
        <div className="mt-10">
            ...
            >
                <div className="bg-black bg-opacity-80 max-w-full">
                    <Container>
                        <div className="container mx-auto p-6 lg:p-12 grid md:grid-cols-2 lg:grid-cols-4 grid-cols-1 gap-8 items-center">
                            <div>
                                <img
