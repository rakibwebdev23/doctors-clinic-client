...
const Footer = () => {
    return (
        <div className="mt-10">
            ...
            >
                <div className="container mx-auto p-6 lg:p-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 bg-black bg-opacity-60 max-w-full">
                    <div>
                        <img
                            className="w-24 mb-4"
                    ...
                    <div className="font-semibold">
                        <h6 className="text-lg font-semibold mb-4 text-orange-500 uppercase">Services</h6>
                    ...
                    <div className="font-semibold">
                        <h6 className="text-lg font-semibold mb-4 text-orange-500 uppercase">Company</h6>
                        <ul className="space-y-2">
                    ...
                    <div className="font-semibold">
                        <h6 className="text-lg font-semibold mb-4 text-orange-500 uppercase">Legal</h6>
                        <ul className="space-y-2">
