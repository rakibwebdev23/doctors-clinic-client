    ...
    return (
        ...
        >
            <div className="hero-content hero-overlay bg-blue-600 bg-opacity-30 text-center max-w-full">
                <div className="w-full lg:w-3/4 justify-center bg-orange-500 bg-opacity-40 flex items-center p-2 text-justify lg:text-center mx-auto mt-14 rounded-xl lg:rounded-none">
                    <div className="p-4 md:p-8 lg:p-10">
                        ...
                        <p className="mb-4 md:mb-5 text-white text-justify tracking-normal">
                            {description}
                        </p>
                    </div>
                </div>
